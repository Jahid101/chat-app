...
export function LoginDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 grid animate-in place-items-center bg-foreground/30 p-4 backdrop-blur-sm fade-in duration-200">
      <div className="w-full max-w-md animate-in rounded-3xl border border-border bg-card p-6 shadow-2xl zoom-in-95 slide-in-from-bottom-2 fade-in duration-300">
